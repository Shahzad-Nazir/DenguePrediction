<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteData.aspx.cs" Inherits="UpdatedShahbazAhmad.DeleteData" %>
...
<div class="row">
    ...
    OnPageIndexChanging="OnPageIndexChanging" PageSize="10" AutoGenerateSelectButton="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
		...
		&nbsp;</p>
            <p>
				Patient Gender:<br />
                          <asp:TextBox ID="txt_gender" runat="server" BackColor="White" BorderColor="Black" Width="407px"  ReadOnly="True" ></asp:TextBox>
...
&nbsp;
            ...
            <asp:TextBox ID="txt_status" runat="server" BackColor="White" BorderColor="Black" Width="407px" ReadOnly="True" ></asp:TextBox>
            </p>
		<p>
			Patient Age:
            <asp:TextBox ID="txt_age" runat="server" BackColor="White" BorderColor="Black" Width="407px" ReadOnly="True" ></asp:TextBox>
		</p>
        		
               <p>
				Patient Report Results:<br />
             
            <asp:TextBox ID="txt_report" runat="server" BackColor="White" BorderColor="Black" Width="407px"  ReadOnly="True" ></asp:TextBox>
