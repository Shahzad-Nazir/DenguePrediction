...
{
    public partial class WeeklyDistrict : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
           ...
           if (DropDownList4.SelectedValue == "" || DropDownList4.Items[DropDownList4.SelectedIndex].Text == "City")
            {
            ...
            else
            {
                ...
                if (DropDownList3.SelectedValue == "1")
                {
                    ...
                    cmd1.CommandText = "select Date, Cases,Prediction_Value from DengueMonitoring.dbo.tbl_prediction where Date >='" + date1 + "' and Date <= '" + date2 + "' and City='" + DropDownList4.Items[DropDownList4.SelectedIndex].Text + "' order by Date Asc";
