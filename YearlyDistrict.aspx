<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YearlyDistrict.aspx.cs" Inherits="UpdatedShahbazAhmad.YearlyDistrict" %>
...
<div class="row">
	...
	<div class="six columns">
		<div class="sectiontitle">
			<h4>Yearly Analysis of Districts</h4>
		</div>

        	<p>
			Select District:<br />
             
&nbsp;<asp:DropDownList ID="DropDownList2" runat="server" Height="28px" Width="406px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
