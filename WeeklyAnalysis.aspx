<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeeklyAnalysis.aspx.cs" Inherits="UpdatedShahbazAhmad.WeeklyAnalysis" %>
...
<div id="subheader">
	<div class="row">
		<div class="twelve columns">
			<p class="left">
				 <b><span>Dengue Virus in Punjab Pakistan</span></b></p>
		</div>
	</div>
</div>
<div class="hr">
...
&nbsp;<asp:DropDownList ID="DropDownList3" runat="server" Height="28px" Width="406px">
                    ...
                    <asp:ListItem Value="2">Second Week</asp:ListItem>
                    <asp:ListItem Value="3">Third Week</asp:ListItem>
                    <asp:ListItem Value="4">Fourth Week</asp:ListItem>
            </asp:DropDownList>
		</p>
		...
		<div class="slider-wrapper theme-default">
            ...
            <asp:Chart ID="Chart1" runat="server" Width="950px" Height="475px">
                  <Series>
                 <asp:Series ChartType="Spline" Name="Actual Cases" XValueMember="Date" YValueMembers="Cases" YValuesPerPoint="2">
                 </asp:Series>
                 <asp:Series ChartArea="ChartArea1"  ChartType="Spline" Name="Predicted Cases" XValueMember="Date" YValueMembers="Prediction" YValuesPerPoint="2" Color="Red">
                 </asp:Series>
