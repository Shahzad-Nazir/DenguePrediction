<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPassword.aspx.cs" Inherits="UpdatedShahbazAhmad.NewPassword" %>
...
<div class="row">
	...
	<div class="six columns">
		...
		<p>
			Enter Old Password:
            <asp:TextBox ID="txt_old" runat="server" BackColor="White" BorderColor="Black" Width="407px" Placeholder="Name"></asp:TextBox>
		</p>
        		<p>
			Enter New Password:
            ...
            <asp:TextBox ID="txt_confirm" runat="server" BackColor="White" BorderColor="Black" Width="407px" TextMode="Password" Placeholder="******"></asp:TextBox>
		</p>
        ...
        <p>
            <asp:Label ID="Label1" runat="server" Font-Size="Small" ForeColor="Red" Text="Data do not exist!" Visible="False"></asp:Label>
